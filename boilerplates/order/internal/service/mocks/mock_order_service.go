...
// CancelOrder provides a mock function with given fields: ctx, orderUpdate
func (_m *OrderService) CancelOrder(ctx context.Context, orderUpdate model.UpdateOrder) error {
...
func (_e *OrderService_Expecter) CancelOrder(ctx interface{}, orderUpdate interface{}) *OrderService_CancelOrder_Call {
	return &OrderService_CancelOrder_Call{Call: _e.mock.On("CancelOrder", ctx, orderUpdate)}
}

func (_c *OrderService_CancelOrder_Call) Run(run func(ctx context.Context, orderUpdate model.UpdateOrder)) *OrderService_CancelOrder_Call {
...
func (_c *OrderService_CancelOrder_Call) RunAndReturn(run func(context.Context, model.UpdateOrder) error) *OrderService_CancelOrder_Call {
	_c.Call.Return(run)
	return _c
}
...
// PayOrder provides a mock function with given fields: ctx, orderUpdate
func (_m *OrderService) PayOrder(ctx context.Context, orderUpdate model.UpdateOrder) error {
	ret := _m.Called(ctx, orderUpdate)
...
//   - ctx context.Context
//   - orderUpdate model.UpdateOrder
func (_e *OrderService_Expecter) PayOrder(ctx interface{}, orderUpdate interface{}) *OrderService_PayOrder_Call {
	return &OrderService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, orderUpdate)}
}

func (_c *OrderService_PayOrder_Call) Run(run func(ctx context.Context, orderUpdate model.UpdateOrder)) *OrderService_PayOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.UpdateOrder))
	})
	return _c
...
func (_c *OrderService_PayOrder_Call) Return(_a0 error) *OrderService_PayOrder_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *OrderService_PayOrder_Call) RunAndReturn(run func(context.Context, model.UpdateOrder) error) *OrderService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
