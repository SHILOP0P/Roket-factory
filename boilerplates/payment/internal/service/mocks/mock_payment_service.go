...
func (_m *PaymentService) PayOrder(ctx context.Context, orderUUID string, userUUID string, method model.PaymentMethod) (string, error) {
...
func (_e *PaymentService_Expecter) PayOrder(ctx interface{}, orderUUID interface{}, userUUID interface{}, method interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, orderUUID, userUUID, method)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, orderUUID string, userUUID string, method model.PaymentMethod)) *PaymentService_PayOrder_Call {
...
func (_c *PaymentService_PayOrder_Call) RunAndReturn(run func(context.Context, string, string, model.PaymentMethod) (string, error)) *PaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
