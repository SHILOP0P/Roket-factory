...
// Category задает категорию детали.
type Category int32
...
// Part описывает деталь на складе.
type Part struct {
...
// PartsFilter задает условия фильтрации для списка деталей.
...
// Manufacturer содержит данные о производителе детали.
...
// Value хранит произвольное значение метаданных.
type Value struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	5,  // 10: inventory.v1.Part.MetadataEntry.value:type_name -> inventory.v1.Value
